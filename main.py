...
from cpmgala import CPMAIVAN

__CHANNEL_USERNAME__ = "@Aivansarte"
__GROUP_USERNAME__   = "@Aivansarte"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - t.me/Aivan sarte_original"
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '    𝐒𝐇𝐀𝐑𝐈𝐍𝐆 𝐓𝐇𝐄 AIVAN SARTE'))
    print(Colorate.Horizontal(Colors.rainbow, f' ‌           𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: @{AIVAN SARTE} 𝐎𝐫 @{AIVAN SARTE}'))
    print(Colorate.Horizontal(Colors.rainbow, '=================================================================='))
